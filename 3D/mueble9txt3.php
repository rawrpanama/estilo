...
if (isset($_SESSION['suser'])) {
  ...
  conexion();
$mbid=59;
$q = mysql_query("SELECT vis FqblenderROM mueble WHERE idmueble='".$mbid."'");
...
<html lang="es">
	...
	<div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
		    ...
		    <ul>
		      ...
		      <li><a href="../reser.php?m=59" class="btn-floating blue tooltipped" data-position="left" data-delay="50" data-tooltip="Reservar"><i class="large mdi-editor-attach-file"></i></a></li>
		    </ul>
		  </div>
</html>
 <?php
